        ...
        matchingRoomStartBtn.setOnClickListener(new OnSingleClickListener() {
            ...
            public void onSingleClick(View v) {
                ...
                if (master == true) {
                    ...
                    battle = new Battle(
                            title,
                            "GuestUID", (t + 604799), 300, 300, grade, 6, 6,0,
                            "day", "day", "day", "day", "day",
                            "day", "day", "day", "day", "day",
                            "false", "false", "false"
                    );
                    ...
                    battleDay = new BattleDay(0,0,0,0,0,0,0);
                    battleValue = battleDay.toMap();
                    childUpdates.put("/Battle/" + title + "day", battleValue);
                    databaseReference.updateChildren(childUpdates);

                    battleEnemyDay = new BattleEnemyDay(0,0,0,0,0,0,0);
                    battleValue = battleEnemyDay.toMap();
                    childUpdates.put("/Battle/" + title + "enemyday", battleValue);
                    databaseReference.updateChildren(childUpdates);
