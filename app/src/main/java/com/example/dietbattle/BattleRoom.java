...
public class BattleRoom extends AppCompatActivity {
    ...
    ArrayList<Integer> myGraphDb = new ArrayList<Integer>();
    ArrayList<Integer> enemyGraphDb = new ArrayList<Integer>();
    ...
    DatabaseReference refbattle, graph, enemygraph;
    int currentday;
                                ...
                                public void onClick(View view) {
                                    ...
                                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int id) {
                                            ...
                                            DatabaseReference enemyDay = FirebaseDatabase.getInstance().getReference().child("Battle").child(myUserDb.get(10)+"enemyday");
                                            DatabaseReference day = FirebaseDatabase.getInstance().getReference().child("Battle").child(myUserDb.get(10)+"day");

                                            /// 게스트 마스터 판별기 후 그에따른 미션 클리어 및 DB 반영
                                            if(myBattleDb.get(1).equals(user.getUid())){
                                                if(!tvMission[index].getText().toString().equals("미션클리어")) {
                                                    ...
                                                    enemyDay.child("day"+currentday).setValue(enemyGraphDb.get(currentday)+1);
                                                }else{
                                                ...
                                                if(!tvMission[index].getText().toString().equals("미션클리어")) {
                                                    ...
                                                    ivMissionCheckBox[index].setImageResource(R.drawable.checkbox2);
                                                    ivMissionCheckBox[index].setEnabled(false);
                                                    day.child("day"+currentday).setValue(myGraphDb.get(currentday)+1);
                                                }else{
                                                    Toast.makeText(getApplicationContext(),"이미 완료한 미션입니다.",Toast.LENGTH_SHORT).show();
                                                }
                                            }
                            ...
                            public boolean onTouch(View view, MotionEvent motionEvent) {
                                switch (motionEvent.getAction()) {
                                    ...
                                    case MotionEvent.ACTION_UP:
                                        ...
                                        if (myBattleDb.get(1).equals(user.getUid())) {
                                            Log.e("test","포인트 게스트 반응");
                                            int guestHp = Integer.parseInt(myBattleDb.get(4)) + 10;
                                            if (guestHp > 300) {
                                                Toast.makeText(getApplicationContext(), "HP를 더이상 회복할수 없습니다.", Toast.LENGTH_SHORT).show();
                                            }else if(Integer.parseInt(myUserDb.get(7))<100) {
                                                Toast.makeText(getApplicationContext(), "포인트가 부족합니다..", Toast.LENGTH_SHORT).show();
                                            }
                                            else {
                                                Toast.makeText(getApplicationContext(), "체력이 회복 되었습니다.", Toast.LENGTH_SHORT).show();
                                                databaseReference.child("User").child(user.getUid()).child("current_point").setValue(Integer.parseInt(myUserDb.get(7))-100);
                                                databaseReference.child("Battle").child(myUserDb.get(10)).child("guestHP").setValue(guestHp);
                                            }
                                        } else {
                                            Log.e("test","포인트 마스터 반응");
                                            int masterHp = Integer.parseInt(myBattleDb.get(3)) + 10;
                                            if (masterHp > 300) {
                                                Toast.makeText(getApplicationContext(), "HP를 더이상 회복할수 없습니다.", Toast.LENGTH_SHORT).show();
                                            }else if(Integer.parseInt(myUserDb.get(7))<100) {
                                                Toast.makeText(getApplicationContext(), "포인트가 부족합니다..", Toast.LENGTH_SHORT).show();
                                                ...
                                                Toast.makeText(getApplicationContext(), "체력이 회복 되었습니다.", Toast.LENGTH_SHORT).show();
                                                databaseReference.child("User").child(user.getUid()).child("current_point").setValue(Integer.parseInt(myUserDb.get(7))-100);
                                                databaseReference.child("Battle").child(myUserDb.get(10)).child("masterHP").setValue(masterHp);
                            ...
                            public boolean onTouch(View view, MotionEvent motionEvent) {
                                switch (motionEvent.getAction()) {
                                    ...
                                    case MotionEvent.ACTION_UP:
                                        ...
                                        if (myBattleDb.get(1).equals(user.getUid())) {
                                            Log.e("test","포인트 게스트 반응");
                                            int guestHp = Integer.parseInt(myBattleDb.get(4)) + 30;
                                            if (guestHp > 300) {
                                                Toast.makeText(getApplicationContext(), "HP를 더이상 회복할수 없습니다.", Toast.LENGTH_SHORT).show();
                                            }else if(Integer.parseInt(myUserDb.get(7))<200) {
                                                Toast.makeText(getApplicationContext(), "포인트가 부족합니다..", Toast.LENGTH_SHORT).show();
                                            }
                                            else {
                                                Toast.makeText(getApplicationContext(), "체력이 회복 되었습니다.", Toast.LENGTH_SHORT).show();
                                                databaseReference.child("User").child(user.getUid()).child("current_point").setValue(Integer.parseInt(myUserDb.get(7))-200);
                                                databaseReference.child("Battle").child(myUserDb.get(10)).child("guestHP").setValue(guestHp);
                                            }
                                        } else {
                                            Log.e("test","포인트 마스터 반응");
                                            int masterHp = Integer.parseInt(myBattleDb.get(3)) + 30;
                                            if (masterHp > 300) {
                                                Toast.makeText(getApplicationContext(), "HP를 더이상 회복할수 없습니다.", Toast.LENGTH_SHORT).show();
                                            }else if(Integer.parseInt(myUserDb.get(7))<200) {
                                                Toast.makeText(getApplicationContext(), "포인트가 부족합니다..", Toast.LENGTH_SHORT).show();
                            ...
                            public boolean onTouch(View view, MotionEvent motionEvent) {
                                switch (motionEvent.getAction()) {
                                    ...
                                    case MotionEvent.ACTION_UP:
                                        ...
                                        if (myBattleDb.get(1).equals(user.getUid())) {
                                            Log.e("test","포인트 게스트 반응");
                                            int guestHp = Integer.parseInt(myBattleDb.get(4)) + 60;
                                            if (guestHp > 300) {
                                                Toast.makeText(getApplicationContext(), "HP를 더이상 회복할수 없습니다.", Toast.LENGTH_SHORT).show();
                                            }else if(Integer.parseInt(myUserDb.get(7))<300) {
                                                Toast.makeText(getApplicationContext(), "포인트가 부족합니다..", Toast.LENGTH_SHORT).show();
                                            }
                                            else {
                                                Toast.makeText(getApplicationContext(), "체력이 회복 되었습니다.", Toast.LENGTH_SHORT).show();
                                                databaseReference.child("User").child(user.getUid()).child("current_point").setValue(Integer.parseInt(myUserDb.get(7))-300);
                                                databaseReference.child("Battle").child(myUserDb.get(10)).child("guestHP").setValue(guestHp);
                                            }
                                        } else {
                                            Log.e("test","포인트 마스터 반응");
                                            int masterHp = Integer.parseInt(myBattleDb.get(3)) + 60;
                                            if (masterHp > 300) {
                                                Toast.makeText(getApplicationContext(), "HP를 더이상 회복할수 없습니다.", Toast.LENGTH_SHORT).show();
                                            }else if(Integer.parseInt(myUserDb.get(7))<300) {
                                                Toast.makeText(getApplicationContext(), "포인트가 부족합니다..", Toast.LENGTH_SHORT).show();
    ...
    void firstReadDB() {
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                currentday = (int) (totalSec / 86400);  //현재 하루가 지난 시점인지 검사 1일=6 2일=5
                ...
                BattleDay battleDay = snapshot.child("Battle").child(myUserDb.get(10)+"day").getValue(BattleDay.class);
                BattleEnemyDay battleEnemyDay = snapshot.child("Battle").child(myUserDb.get(10)+"enemyday").getValue(BattleEnemyDay.class);

                Integer[] battleDayNum = {battleDay.day0,battleDay.day1,battleDay.day2,
                        battleDay.day3,battleDay.day4,battleDay.day5,battleDay.day6};
                Integer[] battleEnemyDayNum = {battleEnemyDay.day0,battleEnemyDay.day1,battleEnemyDay.day2,battleEnemyDay.day3,
                        battleEnemyDay.day4,battleEnemyDay.day5,battleEnemyDay.day6};
                for (int i=0; i < battleDayNum.length; i++) {
                    myGraphDb.add(battleDayNum[i]);
                    enemyGraphDb.add(battleEnemyDayNum[i]);
                }
                graphDB();
            }
    ...
    void readBattle(){
        ...
        maddChildEventListener = new ChildEventListener() {
            ...
            ///이긴 사람이 정해질 시 그에 맞는 승패 다이얼로그 띄어주는 부분
...
//                    myBattleDb.set(3,String.valueOf(snapshot.getValue()));
   ...
   ArrayList<Integer> deliverMy() {return myGraphDb; };
    ArrayList<Integer> deliverEnemy() {return enemyGraphDb; };
   ...
   /// 이긴 사람에게 띄어주는 다이얼로그
    ...
    void graphDB() {
        ...
        graph.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
            ...
            @Override
            public void onChildChanged(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                if(snapshot.getKey().equals("day"+currentday)) {
                    Integer my = snapshot.getValue(Integer.class);
                    myGraphDb.set(currentday, my);
                }
            }
        ...
        enemygraph.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
            ...
            public void onChildChanged(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                if(snapshot.getKey().equals("day"+currentday)){
                    Integer enemy = snapshot.getValue(Integer.class);
                    enemyGraphDb.set(currentday, enemy);
                }
            }
    ...
    void changeUser(){
        ...
        ref.addChildEventListener(new ChildEventListener() {
            ...
            @Override
            public void onChildChanged(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                if(snapshot.getKey().equals("current_point")){
                    if(myBattleDb.get(1).equals(user.getUid())){
                        Integer currentPoint = snapshot.getValue(Integer.class);
                        myUserDb.set(7,String.valueOf(currentPoint));
                        battleRoomPointTv.setText(myUserDb.get(7));
                    }else{
                        Integer currentPoint = snapshot.getValue(Integer.class);
                        myUserDb.set(7,String.valueOf(currentPoint));
